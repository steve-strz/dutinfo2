...
//		exec.runExperiment(new StarterPacMan(), new Legacy2TheReckoning(),numTrials);
		...
		double[] array = exec.runExperiment2(new RandomNonRevPacMan(), new Legacy2TheReckoning(),numTrials);
//		System.out.println("Score in a array : " + Arrays.toString(array));
...
//		exec.runGameTimedSpeedOptimised(new MyMCTSPacMan(new AggressiveGhosts()),new AggressiveGhosts(),fixedTime,visual);
	...
	public double[] runExperiment2(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
	{
		double avgScore=0;
